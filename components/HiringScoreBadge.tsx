...
/**
 * Dual-ring badge: the outer ring renders the Hiring Score (0–100), the inner
 * ring renders the Confidence Score (0–100). The center number is the score;
 * the small footer reads "PHS · CONF n%".
 */
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span
          className={`num font-semibold ${fontSize}`}
          style={{ color }}
        >
          {score}
        </span>
